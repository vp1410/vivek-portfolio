      ...
      <Container className="py-24">
        <div className="overflow-hidden rounded-3xl border border-blue-400/20 bg-blue-500/10 px-7 py-14 text-center sm:px-12">
          ...
          <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-semibold tracking-tight text-white sm:text-5xl">
            Looking for an engineer who can turn complex ideas into production
            systems?
          </h2>

          <p className="mx-auto mt-6 max-w-2xl leading-7 text-slate-300">
            I am currently exploring senior software engineering opportunities
            across full-stack, backend, cloud and AI-focused teams.
          </p>

          <a
            href="mailto:vicky.vivek14@gmail.com?subject=Software%20Engineering%20Opportunity"
